...
def OneChatNotify(userid, oneid, message):
    try:
        ...
        token = 'Bearer A0e9e3b04ac6e5ce79e1289f2cbc2966779a72895d38144bf80adccc86cd44ea54049ac6b5715494cbdde4c9a4fc22f1b'
        headers = {'Authorization': token}

        body = {
        "to" : userid,
        "bot_id" : "B49a5e3f7609a581f9bc3001b924d72c9",
        "type" : "text",
        "message" : message,
        }
...
def get_token(platform):
    try:
        ...
        if "Intel" in platform:
            each_platform_vm_url = "http://203.151.155.117:6100/get_token"
            if platform == 'Intel_dom4':
                fetch_data_from_vm_url = 'https://172.23.15.99/suite-api/api/auth/token/acquire'
                body = {"username": "report", "password": "1Net@1ntelvmware", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                }
        if "HPE" in platform:
            each_platform_vm_url = "http://203.150.92.191:6100/get_token"
            if platform == 'HPE_dom1':
                fetch_data_from_vm_url = 'https://hpcloud-healthmonitor.inet.co.th/suite-api/api/auth/token/acquire'
                body = {"username": "admin", "password": "1Net@Hpe59", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                }
            elif platform == 'HPE_dom2':
                fetch_data_from_vm_url = 'https://hpecloudservicemonitor.inet.co.th/suite-api/api/auth/token/acquire'
                body = {"username": "admin", "password": "1Net@Hpe59", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                ...
                fetch_data_from_vm_url = 'https://hpcloudsimplivitymonitor.inet.co.th/suite-api/api/auth/token/acquire'
                body = {"username": "admin", "password": "1Net@Hpe59", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
        ...
        if "Flexpod" in platform:    
            print("in flexpod 1")
            each_platform_vm_url = "http://203.151.39.55:6100/get_token"    
            if platform == 'Flexpod_dom1':
                fetch_data_from_vm_url = 'https://10.20.80.35/suite-api/api/auth/token/acquire'
                body = {"username": "admin", "password": "6yHnmju&", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                }
            elif platform == 'Flexpod_dom2':
                fetch_data_from_vm_url = 'https://vrealize.inet.co.th/suite-api/api/auth/token/acquire'
                body = {"username": "prasert.tu", "password": "6yHnmju&", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                }
                ...
                fetch_data_from_vm_url = 'https://10.100.10.25/suite-api/api/auth/token/acquire'
                body = {"username": "admin", "password": "6yHnmju&", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                ...
                fetch_data_from_vm_url = 'https://203.154.44.131/suite-api/api/auth/token/acquire'
                body = {"username": "admin", "password": "6yHnmju&", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
        ...
        if "Dell" in platform:
            each_platform_vm_url = "http://203.154.38.52:6100/get_token"
            if platform == 'Dell_dom2':
                fetch_data_from_vm_url = 'https://192.168.8.43/suite-api/api/auth/token/acquire'
                body = {"username": "admin", "password": "1Net@d3llcl0udMGT", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                }
            elif platform == 'Dell_dom3_PRD':
                fetch_data_from_vm_url = 'https://192.168.11.229/suite-api/api/auth/token/acquire'
                body = {"username": "admin", "password": "1Net@d3llcl0udMGT", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
                ...
                fetch_data_from_vm_url = 'https://192.168.10.24/suite-api/api/auth/token/acquire'
                body = {"username": "admin", "password": "1Net@d3llcl0udMGT", "authSource": "Local"}
                headers = {
                    "Content-Type": "application/json",
                    "Accept": "application/json"
...
def query_metrics_resources(token, resourceId, startdate, enddate, platform):
    ...
    compress_variable_key_to_each_platform = {}
    if "Intel" in platform:
        each_platform_vm_url = "http://203.151.155.117:6100/fetch_data"
        if platform == 'Intel_dom4':
            print("token : ", token)
            fetch_data_from_vm_url = 'https://172.23.15.99/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
        ...
        each_platform_vm_url = "http://203.150.92.191:6100/fetch_data"
        if platform == 'HPE_dom1':
            fetch_data_from_vm_url = 'https://hpcloud-healthmonitor.inet.co.th/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://hpecloudservicemonitor.inet.co.th/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://hpcloudsimplivitymonitor.inet.co.th/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
        ...
        each_platform_vm_url = "http://203.151.39.55:6100/fetch_data" 
        if platform == 'Flexpod_dom1':
            fetch_data_from_vm_url = 'https://10.20.80.35/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://vrealize.inet.co.th/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://10.100.10.25/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://203.154.44.131/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
        ...
        each_platform_vm_url = "http://203.154.38.52:6100/fetch_data"
        if platform == 'Dell_dom2':
            fetch_data_from_vm_url = 'https://192.168.8.43/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://192.168.11.229/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://192.168.10.24/suite-api/api/resources/stats/query'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
...
def export_pic(vreal_graph_data):
    try:
        ...
        for i in range(1,count_disk):
            ...
            # fig.write_image("C:/Users/Khanoon/travel_assistance/picture/disk{}.png".format(i+1))
...
def send_picture_to_onechat(user_id, oneid, keep_byte_image):
    ...
    url = "https://chat-api.one.th/message/api/v1/push_message"
    bot_id = "B49a5e3f7609a581f9bc3001b924d72c9"
    Authorization = "Bearer A0e9e3b04ac6e5ce79e1289f2cbc2966779a72895d38144bf80adccc86cd44ea54049ac6b5715494cbdde4c9a4fc22f1b"
